<div class="card p-3">
    <div class="card-title">
        <h3 class="ps-3">Tambah Buku Baru</h3>
    </div>
    <div class="card-body">
        <form action="index.php?page=store-buku" method="POST">
            <div class="row">
                <div class="col mb-3">
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description"
                        placeholder="Masukkan deskripsi buku secara singkat" rows="5" style="resize: none;"></textarea>
                </div>
            </div>
            <div class="mt-3">
